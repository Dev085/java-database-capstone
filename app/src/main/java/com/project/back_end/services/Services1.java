...
public class Services1 {
    ...
    public Services1(TokenService tokenService,
    ...
    // 3. Filtrar doctores por nombre, especialidad y horario
    ...
    // 4. Validar disponibilidad de cita
    public int validateAppointment(Appointment appointment) {
        ...
        return availableSlots.contains(requestedTime.toString()) ? 1 : 0;
    }

    // 5. Validar si el paciente ya existe
    public boolean validatePatient(Patient patient) {
        return patientRepository.findByEmailOrPhone(patient.getEmail(), patient.getPhone()) == null;
    }

    // 6. Validar login de paciente
    ...
    // 7. Filtrar citas del paciente por condición y/o doctor
    public ResponseEntity<Map<String, Object>> filterPatient(String condition, String name, String token) {
        ...
        boolean filterByCondition = condition != null && !"all".equalsIgnoreCase(condition);
        boolean filterByName = name != null && !"all".equalsIgnoreCase(name);

        if (filterByCondition && filterByName) {
            return patientService.filterByDoctorAndCondition(condition, name, patient.getId());
        } else if (filterByCondition) {
